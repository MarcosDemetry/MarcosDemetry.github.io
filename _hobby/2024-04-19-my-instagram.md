...
tags: [data, personal]
---
How does my online behavior change as new chapters of my life start?
...
#### Likes
The number of likes follows an interesting pattern. At the end of each episode of life, I seem to like many more posts. 
This is especially the case for finishing the bachelor's and the master's studies. I attribute this to having been with a big graduating cohort
...
<img src = "/assets/img/hobby-exploring-insta/liked_posts_cumsum.png" width ="100%"/>

#### Comments
Similarly, it seems I comment on other people's posts toward the end of each episode of life.
<img src = "/assets/img/hobby-exploring-insta/comments_cumsum.png" width ="100%"/>

We could also see that the number of unique people on whose posts I comment increases greatly in the first year at uni (2013), first year of the master's (2016), first year of the PhD (2021) and my semester abroad (2023).
<img src = "/assets/img/hobby-exploring-insta/comments_unique_owners_year.png" width ="100%"/>
...
<img src = "/assets/img/hobby-exploring-insta/stories_cumsum.png" width ="100%"/>
...
This is especially prominent when starting the master's (perhaps, the last bigger cohort I've joined since then).
...
Luckily, it seems that I was least pretentious in high school and right now (unless there's some purely mechanical reason for these convergences that I'm missing now).
<img src = "/assets/img/hobby-exploring-insta/followers_following_cumsum.png" width ="100%"/>

So, I do interact with more people and more often on social media around entering or leaving a new academic chapter in life.
