...
Some authors collaborate several times, which gives us 738 unique author combinations.
Top authors (counting their appearances as single authors and co-authors) are:
...
For example, keyword co-occurrences look like this:
...
There's a programming cluster (green-purple, bottom-right), a statistics cluster (green-yellow, top-left),
and an economics/econometrics cluster (yellow, bottom-left).
