...
<details>
  ...
  The __main identifying assumption__ is continuity, i.e., in absence of treatment we would not see any discontinuities at the cutoff.
  ...
  Testing the manipulation assumption with a McCrary test and by plotting histograms shows __no bunching__ around any of our cutoffs.

  An alternative to evaluating each running variable separately is to use a __standardized distance to cutoff__ as a running variable. 
  ...
  __Overall__, there is __no statistically significant effect__ of the reform on the main financial outcomes.
