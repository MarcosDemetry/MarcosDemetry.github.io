...
---
<a href="/assets/articles/hmindex-v2.pdf" onclick="if(window.gtag) gtag('event', 'file_download', {file_name: 'hmindex-v2.pdf', file_extension: 'pdf', link_text: 'WP version'});">WP version</a> -- [Github Repo](https://github.com/MarcosDemetry/hmindex)
