---
layout: page
thumbnail-img: /assets/img/research-rpaxioms/plot2_BL_actual_preferred.png
...
---
<a href="/assets/articles/Demetry-et-al-2022.pdf" onclick="if(window.gtag) gtag('event', 'file_download', {file_name: 'Demetry-et-al-2022.pdf', file_extension: 'pdf', link_text: 'PDF'});">PDF</a> -- [Github Repo](https://github.com/MarcosDemetry/rpaxioms_repo)
...
## Total downloads: 4,284
<img src="/assets/img/research-rpaxioms/rpaxioms_cumulative_hits.png" alt="number of downloads" width="100%"/>

<details>
  <summary>Project Timeline from Start until Today</summary>
  
  <p>
    <img src="/assets/img/research-rpaxioms/rpaxioms_paper_timeline_part1.png" alt="Project timeline part 1" width="100%"/>
    <img src="/assets/img/research-rpaxioms/rpaxioms_paper_timeline_part2.png" alt="Project timeline part 2" width="100%"/>
    <img src="/assets/img/research-rpaxioms/rpaxioms_paper_timeline_part3.png" alt="Project timeline part 3" width="100%"/>
  </p>
</details>
